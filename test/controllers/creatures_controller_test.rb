...
class CreaturesControllerTest < ActionController::TestCase
  ...
  test "should create creature" do
    assert_difference('Creature.count') do
      post :create, creature: { activation_until: @creature.activation_until, animal_id: @creature.animal_id }
    end
  ...
  test "should update creature" do
    patch :update, id: @creature, creature: { activation_until: @creature.activation_until, animal_id: @creature.animal_id }
    assert_redirected_to creature_path(assigns(:creature))
  end
